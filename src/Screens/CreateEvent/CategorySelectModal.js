...
import { categoryModalData, saveCategoryData, SELECTED } from '../../Store/Action/Action'
    ...
    return (
      <View style={styles.containerStyleModal}>
        <View style={styles.category} >
          ...
          <TouchableOpacity onPress={() => this.props.navigation.navigate('CreateEventStep2')} activeOpacity={1} >
